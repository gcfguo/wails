...
import (
	...
	"github.com/gcfguo/wails/v2/internal/frontend/desktop"
	"github.com/gcfguo/wails/v2/internal/frontend/devserver"
	"github.com/gcfguo/wails/v2/internal/frontend/dispatcher"
	"github.com/gcfguo/wails/v2/internal/frontend/runtime"
	...
	pkglogger "github.com/gcfguo/wails/v2/pkg/logger"
...
func tryInferAssetDirFromFS(assets iofs.FS) (string, error) {
	...
	fmt.Println("inferAssetDir: ", path)
	return path, nil
}
