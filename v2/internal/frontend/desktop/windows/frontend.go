...
import (
	...
	"github.com/gcfguo/wails/v2/internal/frontend/desktop/windows/win32"
	"github.com/gcfguo/wails/v2/internal/frontend/desktop/windows/winc"
	"github.com/gcfguo/wails/v2/internal/frontend/desktop/windows/winc/w32"
	wailsruntime "github.com/gcfguo/wails/v2/internal/frontend/runtime"
	"github.com/gcfguo/wails/v2/internal/logger"
	"github.com/gcfguo/wails/v2/internal/system/operatingsystem"
	"github.com/gcfguo/wails/v2/pkg/assetserver"
	"github.com/gcfguo/wails/v2/pkg/options"
	"github.com/gcfguo/wails/v2/pkg/options/windows"
...
func (f *Frontend) Run(ctx context.Context) error {
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			// depends on the content in the WebView, see https://github.com/gcfguo/wails/issues/1319
